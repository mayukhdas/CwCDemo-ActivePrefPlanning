...
public class p12
{
	...
	{
		String[] problemConstants = new String[35];
		...
		problemConstants[24] = "camera0";
		problemConstants[25] = "camera";
		problemConstants[26] = "camera1";
		problemConstants[27] = "camera2";
		problemConstants[28] = "camera3";
		problemConstants[29] = "objective0";
		problemConstants[30] = "objective";
		problemConstants[31] = "objective1";
		problemConstants[32] = "objective2";
		problemConstants[33] = "objective3";
		problemConstants[34] = "channel_free";
	...
	private static void createState0(State s)	{
		...
		s.add(new Predicate(3, 0, new TermList(TermConstant.getConstant(62), new TermList(TermConstant.getConstant(64), TermList.NIL))));
		s.add(new Predicate(3, 0, new TermList(TermConstant.getConstant(64), new TermList(TermConstant.getConstant(62), TermList.NIL))));
		...
		s.add(new Predicate(3, 0, new TermList(TermConstant.getConstant(65), new TermList(TermConstant.getConstant(62), TermList.NIL))));
		s.add(new Predicate(3, 0, new TermList(TermConstant.getConstant(62), new TermList(TermConstant.getConstant(65), TermList.NIL))));
		s.add(new Predicate(3, 0, new TermList(TermConstant.getConstant(65), new TermList(TermConstant.getConstant(63), TermList.NIL))));
		s.add(new Predicate(3, 0, new TermList(TermConstant.getConstant(63), new TermList(TermConstant.getConstant(65), TermList.NIL))));
		...
		s.add(new Predicate(10, 0, new TermList(TermConstant.getConstant(61), TermList.NIL)));
		s.add(new Predicate(10, 0, new TermList(TermConstant.getConstant(63), TermList.NIL)));
		...
		s.add(new Predicate(2, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(62), TermList.NIL))));
		...
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(62), new TermList(TermConstant.getConstant(63), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(63), new TermList(TermConstant.getConstant(62), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(60), new TermList(TermConstant.getConstant(61), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(61), new TermList(TermConstant.getConstant(60), TermList.NIL)))));
		...
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(63), new TermList(TermConstant.getConstant(57), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(57), new TermList(TermConstant.getConstant(63), TermList.NIL)))));
		...
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(63), new TermList(TermConstant.getConstant(64), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(64), new TermList(TermConstant.getConstant(63), TermList.NIL)))));
		s.add(new Predicate(2, 0, new TermList(TermConstant.getConstant(49), new TermList(TermConstant.getConstant(62), TermList.NIL))));
		...
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(49), new TermList(TermConstant.getConstant(62), new TermList(TermConstant.getConstant(63), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(49), new TermList(TermConstant.getConstant(63), new TermList(TermConstant.getConstant(62), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(49), new TermList(TermConstant.getConstant(62), new TermList(TermConstant.getConstant(64), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(49), new TermList(TermConstant.getConstant(64), new TermList(TermConstant.getConstant(62), TermList.NIL)))));
		...
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(49), new TermList(TermConstant.getConstant(60), new TermList(TermConstant.getConstant(61), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(49), new TermList(TermConstant.getConstant(61), new TermList(TermConstant.getConstant(60), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(49), new TermList(TermConstant.getConstant(60), new TermList(TermConstant.getConstant(65), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(49), new TermList(TermConstant.getConstant(65), new TermList(TermConstant.getConstant(60), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(49), new TermList(TermConstant.getConstant(63), new TermList(TermConstant.getConstant(59), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(49), new TermList(TermConstant.getConstant(59), new TermList(TermConstant.getConstant(63), TermList.NIL)))));
		s.add(new Predicate(2, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(65), TermList.NIL))));
		...
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(65), new TermList(TermConstant.getConstant(57), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(57), new TermList(TermConstant.getConstant(65), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(65), new TermList(TermConstant.getConstant(59), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(59), new TermList(TermConstant.getConstant(65), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(65), new TermList(TermConstant.getConstant(60), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(60), new TermList(TermConstant.getConstant(65), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(65), new TermList(TermConstant.getConstant(61), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(61), new TermList(TermConstant.getConstant(65), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(65), new TermList(TermConstant.getConstant(63), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(63), new TermList(TermConstant.getConstant(65), TermList.NIL)))));
		...
		s.add(new Predicate(2, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(65), TermList.NIL))));
		...
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(65), new TermList(TermConstant.getConstant(57), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(57), new TermList(TermConstant.getConstant(65), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(65), new TermList(TermConstant.getConstant(59), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(59), new TermList(TermConstant.getConstant(65), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(65), new TermList(TermConstant.getConstant(60), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(60), new TermList(TermConstant.getConstant(65), TermList.NIL)))));
		...
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(65), new TermList(TermConstant.getConstant(62), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(62), new TermList(TermConstant.getConstant(65), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(65), new TermList(TermConstant.getConstant(63), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(63), new TermList(TermConstant.getConstant(65), TermList.NIL)))));
		...
		s.add(new Predicate(16, 0, new TermList(TermConstant.getConstant(66), new TermList(TermConstant.getConstant(51), TermList.NIL))));
		s.add(new Predicate(14, 0, new TermList(TermConstant.getConstant(66), new TermList(TermConstant.getConstant(74), TermList.NIL))));
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(66), new TermList(TermConstant.getConstant(46), TermList.NIL))));
		s.add(new Predicate(16, 0, new TermList(TermConstant.getConstant(68), new TermList(TermConstant.getConstant(50), TermList.NIL))));
		s.add(new Predicate(14, 0, new TermList(TermConstant.getConstant(68), new TermList(TermConstant.getConstant(73), TermList.NIL))));
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(68), new TermList(TermConstant.getConstant(46), TermList.NIL))));
		s.add(new Predicate(16, 0, new TermList(TermConstant.getConstant(69), new TermList(TermConstant.getConstant(48), TermList.NIL))));
		s.add(new Predicate(14, 0, new TermList(TermConstant.getConstant(69), new TermList(TermConstant.getConstant(71), TermList.NIL))));
		...
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(70), new TermList(TermConstant.getConstant(44), TermList.NIL))));
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(70), new TermList(TermConstant.getConstant(46), TermList.NIL))));
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(70), new TermList(TermConstant.getConstant(47), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(71), new TermList(TermConstant.getConstant(57), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(71), new TermList(TermConstant.getConstant(59), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(71), new TermList(TermConstant.getConstant(60), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(73), new TermList(TermConstant.getConstant(57), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(73), new TermList(TermConstant.getConstant(59), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(73), new TermList(TermConstant.getConstant(60), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(73), new TermList(TermConstant.getConstant(61), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(74), new TermList(TermConstant.getConstant(57), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(74), new TermList(TermConstant.getConstant(59), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(74), new TermList(TermConstant.getConstant(60), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(74), new TermList(TermConstant.getConstant(61), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(74), new TermList(TermConstant.getConstant(62), TermList.NIL))));
