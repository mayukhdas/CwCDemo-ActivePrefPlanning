...
(:constraints (and
	...
	(preference p5C (at end (delivered package3 l1 t4)))
	(preference p5D (at end (delivered package4 l1 t8)))
	(preference p5E (at end (delivered package5 l1 t8)))
	(preference p5F (at end (delivered package6 l2 t8)))
	(preference p5G (at end (delivered package7 l4 t12)))
	(preference p5H  (at end (delivered package8 l2 t12)))
