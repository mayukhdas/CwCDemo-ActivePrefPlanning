...
(:constraints (and
	...
	(preference p5A (at end (delivered package1 l3 t4)))
	(preference p5B (at end (delivered package2 l2 t4)))
	(preference p5C (at end (delivered package4 l3 t8)))
	(preference p5D (at end (delivered package5 l3 t8)))
	(preference p5E (at end (delivered package8 l2 t12)))
	(preference p5F (at end (delivered package9 l4 t12)))
