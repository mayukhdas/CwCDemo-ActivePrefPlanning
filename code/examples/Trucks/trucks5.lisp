...
(defdomain trucks
   ...
   (:operator (!load ?p ?t ?a1 ?l)
	       ...
	       (forall () (not (preference_p2a_autstate_1_2(var(p)))) ((preference_p2a_prev_autstate_1_2(var(p)))))
	       (forall () (not (preference_p2a_autstate_1_3(var(p)))) ((preference_p2a_prev_autstate_1_3(var(p)))))
	       (forall () (not (preference_p2a_autstate_1_1(var(p)))) ((preference_p2a_prev_autstate_1_1(var(p)))))
	       (forall () (not (preference_p2a_autstate_1_5(var(p)))) ((preference_p2a_prev_autstate_1_5(var(p)))))
	       (forall () (not (preference_p2a_autstate_1_7(var(p)))) ((preference_p2a_prev_autstate_1_7(var(p)))))
	       ...
	       (forall () ((preference_p2a_autstate_1_2(var(p)))) ((preference_p2a_prev_autstate_1_2(var(p)))))
	       (forall () ((preference_p2a_autstate_1_3(var(p)))) ((preference_p2a_prev_autstate_1_3(var(p)))))
	       (forall () ((preference_p2a_autstate_1_1(var(p)))) ((preference_p2a_prev_autstate_1_1(var(p)))))
	       (forall () ((preference_p2a_autstate_1_5(var(p)))) ((preference_p2a_prev_autstate_1_5(var(p)))))
	       (forall () ((preference_p2a_autstate_1_7(var(p)))) ((preference_p2a_prev_autstate_1_7(var(p)))))
    ...
    (and 
      ...
      (or 
        ...
        (or 
          ...
          (preference_p1b_autstate_3_1))))))
(:- 
  (preference_p2a_autstate_1_2 ?p) 
  (and 
    (preference_p2a_prev_autstate_1_2 ?p) 
    (forall 
      (?a) 
      (not 
        (in ?p ?t ?a)))))
(:- 
  (preference_p2a_autstate_1_3 ?p) 
  (or 
    (and 
      (preference_p2a_prev_autstate_1_2 ?p) 
      (exists 
        ...
        (in ?p ?t ?a))) 
    (and 
      (preference_p2a_prev_autstate_1_3 ?p) 
      (exists 
        (?a) 
        (in ?p ?t ?a)))))
(:- 
  (preference_p2a_autstate_1_1 ?p) 
  (or 
    (preference_p2a_prev_autstate_1_2 ?p) 
    (or 
      (preference_p2a_prev_autstate_1_3 ?p) 
      (or 
        (and 
          (preference_p2a_prev_autstate_1_5 ?p) 
          (forall 
            (?a) 
            (not 
              (in ?p ?t ?a)))) 
        (and 
          (preference_p2a_prev_autstate_1_7 ?p) 
          (forall 
            (?a) 
            (not 
              (in ?p ?t ?a))))))))
(:- 
  (preference_p2a_autstate_1_5 ?p) 
  (or 
    (and 
      (preference_p2a_prev_autstate_1_2 ?p) 
      (exists 
...
(:- 
  ...
  (
    (preference_p2a_autstate_1_1 ?p)))
(:- 
  (preference_p2a_henceforth_satisfied) false)
(:- 
