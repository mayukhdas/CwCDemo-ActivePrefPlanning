...
(preference p5A (at end (delivered package1 l2 t4)))
(preference p5B (at end (delivered package2 l1 t4)))
(preference p5C (at end (delivered package4 l3 t8)))
(preference p5D (at end (delivered package5 l4 t8)))
(preference p5E (at end (delivered package8 l3 t12)))
(preference p5F (at end (delivered package9 l4 t12)))
(preference p5G (at end (delivered package10 l4 t16)))
(preference p5H (at end (delivered package11 l4 t16)))

(preference p5I (at end (delivered package12 l2 t16)))
(preference p5J (at end (delivered package13 l4 t20)))
(preference p5K (at end (delivered package14 l4 t20)))
