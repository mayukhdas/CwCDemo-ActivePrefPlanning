...
(defdomain trucks
   ...
   (:operator (!load ?p ?t ?a1 ?l)
	       ...
	       (forall () (not (preference_p6r_autstate_1_2)) ((preference_p6r_prev_autstate_1_2)))
	       (forall () (not (preference_p6r_autstate_1_1)) ((preference_p6r_prev_autstate_1_1)))
	       ...
	       (forall () ((preference_p6r_autstate_1_2)) ((preference_p6r_prev_autstate_1_2)))
	       (forall () ((preference_p6r_autstate_1_1)) ((preference_p6r_prev_autstate_1_1)))
...
(:- 
  ...
  (or 
    ...
    (preference_p6q_autstate_1_1)))
(:- 
  (preference_p6r_autstate_1_2) 
  (preference_p6r_prev_autstate_1_2))
(:- 
  (preference_p6r_autstate_1_1) 
  (and 
    (preference_p6r_prev_autstate_1_2) 
    (delivered package19 l3 t25)))
(:- 
  (preference_p6r_satisfied) 
  (
    (preference_p6r_autstate_1_1)))
(:- 
  (preference_p6r_henceforth_satisfied) false)
(:- 
  (preference_p6r_optimistically_satisfied) 
  (or 
    (preference_p6r_autstate_1_2) 
    (preference_p6r_autstate_1_1)))
(:- 
