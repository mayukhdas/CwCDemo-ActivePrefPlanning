...
(:constraints (and
	...
	(preference p4B (at end (delivered package8 l3 t12)))
	(preference p4A (at end (delivered package6 l3 t9)))
	...
	(preference p2A1 (at-most-once (exists (?t - truck ?a - truckarea)
	 ...
	 (preference p2A7 (at-most-once (exists (?t - truck ?a - truckarea)
		(in package7 ?t ?a)))) 
		
	
	 (preference p2A8 (at-most-once (exists (?t - truck ?a - truckarea)
		(in package8 ?t ?a)))) 
