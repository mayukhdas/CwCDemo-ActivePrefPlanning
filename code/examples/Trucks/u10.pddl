...
(:constraints (and
  ...
  (preference p5C (at end (delivered package4 l1 t8)))
  (preference p5D (at end (delivered package7 l3 t12)))
  (preference p5E (at end (delivered package10 l1 t16)))
  (preference p5F (at end (delivered package11 l2 t16)))
  (preference p5G (at end (delivered package12 l1 t16)))	   
