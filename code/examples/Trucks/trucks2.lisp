...
(defdomain trucks
   ...
   (:operator (!load ?p ?t ?a1 ?l)
	       ...
	       (forall () (not (preference_p4c_autstate_1_2)) ((preference_p4c_prev_autstate_1_2)))
	       (forall () (not (preference_p4c_autstate_1_1)) ((preference_p4c_prev_autstate_1_1)))
	       ...
	       (forall () ((preference_p4c_autstate_1_2)) ((preference_p4c_prev_autstate_1_2)))
	       (forall () ((preference_p4c_autstate_1_1)) ((preference_p4c_prev_autstate_1_1)))
...
(:- 
  ...
  (or 
    ...
    (preference_p4b_autstate_1_1)))
(:- 
  (preference_p4c_autstate_1_2) 
  (preference_p4c_prev_autstate_1_2))
(:- 
  (preference_p4c_autstate_1_1) 
  (and 
    (preference_p4c_prev_autstate_1_2) 
    (delivered package4 l3 t6)))
(:- 
  (preference_p4c_satisfied) 
  (
    (preference_p4c_autstate_1_1)))
(:- 
  (preference_p4c_henceforth_satisfied) false)
(:- 
  (preference_p4c_optimistically_satisfied) 
  (or 
    (preference_p4c_autstate_1_2) 
    (preference_p4c_autstate_1_1)))
(:- 
