...
(preference p5B (at end (delivered package4 l3 t8)))
(preference p5C (at end (delivered package5 l3 t8)))
(preference p5D (at end (delivered package7 l2 t12)))

(preference p5E (at end (delivered package8 l2 t12)))
(preference p5F (at end (delivered package10 l1 t16)))
(preference p5G (at end (delivered package11 l1 t16)))
(preference p5H (at end (delivered package12 l4 t16)))
(preference p5I (at end (delivered package13 l3 t20)))
(preference p5J  (at end (delivered package14 l3 t20)))
(preference p5K (at end (delivered package15 l3 t20)))
