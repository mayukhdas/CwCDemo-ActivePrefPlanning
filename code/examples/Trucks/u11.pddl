...
(preference p5A (at end (delivered package4 l1 t8)))
(preference p5B (at end (delivered package5 l1 t8)))
(preference p5C (at end (delivered package6 l2 t8)))
(preference p5D (at end (delivered package7 l4 t12)))
(preference p5E (at end (delivered package8 l1 t12)))
(preference p5F (at end (delivered package9 l3 t12)))
