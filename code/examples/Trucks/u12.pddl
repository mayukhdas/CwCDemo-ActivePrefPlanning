...
(:constraints (and
	(preference p5A (at end (delivered package2 l1 t4)))
	(preference p5B (at end (delivered package3 l3 t4)))
	(preference p5C (at end (delivered package4 l2 t8)))
	(preference p5D (at end (delivered package5 l2 t8)))
	(preference p5E (at end (delivered package6 l3 t8)))
	(preference p5F (at end (delivered package7 l3 t12)))
	(preference p5G (at end (delivered package8 l3 t12)))
	(preference p5H  (at end (delivered package9 l2 t12)))
	(preference p5I (at end (delivered package10 l3 t16)))

	(preference p5J (at end (delivered package11 l3 t16)))
	(preference p5K (at end (delivered package12 l3 t16)))
	(preference p5L (at end (delivered package14 l1 t20)))
