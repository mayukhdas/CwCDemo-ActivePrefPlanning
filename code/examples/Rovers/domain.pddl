...
(define (domain Rover)
  (:requirements :typing :constraints :preferences :negative-preconditions)
  ...
  (:predicates (at ?x - rover ?y - waypoint) 
	       ...
	       (have_image ?r - rover ?o - objective ?m - mode)
               (have_image_add ?o - objective ?m - mode)
  ...
  (:action take_image
    ...
    :precondition (and (calibrated ?i ?r)
		       (on_board ?i ?r)
		       (equipped_for_imaging ?r) (not (have_image_add  ?o ?m))
		       (supports ?i ?m)
		       (visible_from ?o ?p)
		       (at ?r ?p))
    :effect (and (have_image ?r ?o ?m) (have_image_add  ?o ?m)
		 (not (calibrated ?i ?r)))
    )
