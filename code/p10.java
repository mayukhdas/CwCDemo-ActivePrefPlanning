...
public class p10
{
	...
	{
		String[] problemConstants = new String[36];
		...
		problemConstants[23] = "camera0";
		problemConstants[24] = "camera";
		problemConstants[25] = "camera1";
		problemConstants[26] = "camera2";
		problemConstants[27] = "camera3";
		problemConstants[28] = "camera4";
		problemConstants[29] = "camera5";
		problemConstants[30] = "objective0";
		problemConstants[31] = "objective";
		problemConstants[32] = "objective1";
		problemConstants[33] = "objective2";
		problemConstants[34] = "objective3";
		problemConstants[35] = "channel_free";
	...
	private static void createState0(State s)	{
		...
		s.add(new Predicate(20, 0, new TermList(TermConstant.getConstant(42), new TermList(TermConstant.getConstant(59), TermList.NIL))));
		...
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(62), new TermList(TermConstant.getConstant(57), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(57), new TermList(TermConstant.getConstant(62), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(62), new TermList(TermConstant.getConstant(59), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(59), new TermList(TermConstant.getConstant(62), TermList.NIL)))));
		...
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(62), new TermList(TermConstant.getConstant(61), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(61), new TermList(TermConstant.getConstant(62), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(62), new TermList(TermConstant.getConstant(64), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(64), new TermList(TermConstant.getConstant(62), TermList.NIL)))));
		...
		s.add(new Predicate(2, 0, new TermList(TermConstant.getConstant(49), new TermList(TermConstant.getConstant(57), TermList.NIL))));
		...
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(49), new TermList(TermConstant.getConstant(57), new TermList(TermConstant.getConstant(59), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(49), new TermList(TermConstant.getConstant(59), new TermList(TermConstant.getConstant(57), TermList.NIL)))));
		...
		s.add(new Predicate(2, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(61), TermList.NIL))));
		...
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(61), new TermList(TermConstant.getConstant(62), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(62), new TermList(TermConstant.getConstant(61), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(61), new TermList(TermConstant.getConstant(63), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(63), new TermList(TermConstant.getConstant(61), TermList.NIL)))));
		...
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(62), new TermList(TermConstant.getConstant(59), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(59), new TermList(TermConstant.getConstant(62), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(62), new TermList(TermConstant.getConstant(60), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(50), new TermList(TermConstant.getConstant(60), new TermList(TermConstant.getConstant(62), TermList.NIL)))));
		s.add(new Predicate(2, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(59), TermList.NIL))));
		...
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(59), new TermList(TermConstant.getConstant(57), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(57), new TermList(TermConstant.getConstant(59), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(57), new TermList(TermConstant.getConstant(60), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(60), new TermList(TermConstant.getConstant(57), TermList.NIL)))));
		...
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(62), new TermList(TermConstant.getConstant(61), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(61), new TermList(TermConstant.getConstant(62), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(64), new TermList(TermConstant.getConstant(63), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(63), new TermList(TermConstant.getConstant(64), TermList.NIL)))));
		s.add(new Predicate(16, 0, new TermList(TermConstant.getConstant(65), new TermList(TermConstant.getConstant(49), TermList.NIL))));
		s.add(new Predicate(14, 0, new TermList(TermConstant.getConstant(65), new TermList(TermConstant.getConstant(75), TermList.NIL))));
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(65), new TermList(TermConstant.getConstant(47), TermList.NIL))));
		s.add(new Predicate(16, 0, new TermList(TermConstant.getConstant(67), new TermList(TermConstant.getConstant(49), TermList.NIL))));
		s.add(new Predicate(14, 0, new TermList(TermConstant.getConstant(67), new TermList(TermConstant.getConstant(76), TermList.NIL))));
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(67), new TermList(TermConstant.getConstant(44), TermList.NIL))));
		s.add(new Predicate(16, 0, new TermList(TermConstant.getConstant(68), new TermList(TermConstant.getConstant(49), TermList.NIL))));
		s.add(new Predicate(14, 0, new TermList(TermConstant.getConstant(68), new TermList(TermConstant.getConstant(74), TermList.NIL))));
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(68), new TermList(TermConstant.getConstant(44), TermList.NIL))));
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(68), new TermList(TermConstant.getConstant(47), TermList.NIL))));
		s.add(new Predicate(16, 0, new TermList(TermConstant.getConstant(69), new TermList(TermConstant.getConstant(49), TermList.NIL))));
		s.add(new Predicate(14, 0, new TermList(TermConstant.getConstant(69), new TermList(TermConstant.getConstant(75), TermList.NIL))));
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(69), new TermList(TermConstant.getConstant(46), TermList.NIL))));
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(69), new TermList(TermConstant.getConstant(47), TermList.NIL))));
		s.add(new Predicate(16, 0, new TermList(TermConstant.getConstant(70), new TermList(TermConstant.getConstant(50), TermList.NIL))));
		s.add(new Predicate(14, 0, new TermList(TermConstant.getConstant(70), new TermList(TermConstant.getConstant(72), TermList.NIL))));
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(70), new TermList(TermConstant.getConstant(44), TermList.NIL))));
		s.add(new Predicate(16, 0, new TermList(TermConstant.getConstant(71), new TermList(TermConstant.getConstant(51), TermList.NIL))));
		s.add(new Predicate(14, 0, new TermList(TermConstant.getConstant(71), new TermList(TermConstant.getConstant(72), TermList.NIL))));
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(71), new TermList(TermConstant.getConstant(44), TermList.NIL))));
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(71), new TermList(TermConstant.getConstant(46), TermList.NIL))));
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(71), new TermList(TermConstant.getConstant(47), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(72), new TermList(TermConstant.getConstant(57), TermList.NIL))));
