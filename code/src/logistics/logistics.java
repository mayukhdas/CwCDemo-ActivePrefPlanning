...
class Precondition0 extends Precondition
{
	...
	public Precondition0(Term[] unifier)
	{
		...
		p[1] = new PreconditionAtomic(new Predicate(5, 10, new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(2), TermList.NIL))), unifier);
		...
		p[3] = new PreconditionAtomic(new Predicate(5, 10, new TermList(TermVariable.getVariable(3), new TermList(TermVariable.getVariable(2), TermList.NIL))), unifier);
		p[4] = new PreconditionAtomic(new Predicate(6, 10, new TermList(TermVariable.getVariable(4), new TermList(TermVariable.getVariable(2), TermList.NIL))), unifier);
		b = new Term[5][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
class Precondition1 extends Precondition
{
	...
	public Precondition1(Term[] unifier)
	{
		...
		p[1] = new PreconditionAtomic(new Predicate(5, 10, new TermList(TermVariable.getVariable(1), new TermList(TermVariable.getVariable(2), TermList.NIL))), unifier);
		p[2] = new PreconditionAtomic(new Predicate(0, 10, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(3), TermList.NIL))), unifier);
		p[3] = new PreconditionAtomic(new Predicate(5, 10, new TermList(TermVariable.getVariable(3), new TermList(TermVariable.getVariable(5), TermList.NIL))), unifier);
		p[4] = new PreconditionAtomic(new Predicate(7, 10, new TermList(TermVariable.getVariable(2), new TermList(TermVariable.getVariable(5), TermList.NIL))), unifier);
		p[5] = new PreconditionAtomic(new Predicate(6, 10, new TermList(TermVariable.getVariable(6), new TermList(TermVariable.getVariable(5), TermList.NIL))), unifier);
		p[6] = new PreconditionAtomic(new Predicate(6, 10, new TermList(TermVariable.getVariable(7), new TermList(TermVariable.getVariable(2), TermList.NIL))), unifier);
		p[7] = new PreconditionAtomic(new Predicate(8, 10, new TermList(TermVariable.getVariable(8), TermList.NIL)), unifier);
		p[8] = new PreconditionAtomic(new Predicate(5, 10, new TermList(TermVariable.getVariable(8), new TermList(TermVariable.getVariable(5), TermList.NIL))), unifier);
		p[9] = new PreconditionAtomic(new Predicate(8, 10, new TermList(TermVariable.getVariable(9), TermList.NIL)), unifier);
		p[10] = new PreconditionAtomic(new Predicate(5, 10, new TermList(TermVariable.getVariable(9), new TermList(TermVariable.getVariable(2), TermList.NIL))), unifier);
		b = new Term[11][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
class Precondition2 extends Precondition
{
	...
	public Precondition2(Term[] unifier)
	{
		...
		p[1] = new PreconditionAtomic(new Predicate(5, 5, new TermList(TermVariable.getVariable(2), new TermList(TermVariable.getVariable(4), TermList.NIL))), unifier);
		p[2] = new PreconditionAtomic(new Predicate(6, 5, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(4), TermList.NIL))), unifier);
		b = new Term[3][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
class Precondition3 extends Precondition
{
	...
	public Precondition3(Term[] unifier)
	{
		...
		p[2] = new PreconditionAtomic(new Predicate(7, 3, new TermList(TermVariable.getVariable(2), new TermList(TermVariable.getVariable(1), TermList.NIL))), unifier);
		b = new Term[3][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
