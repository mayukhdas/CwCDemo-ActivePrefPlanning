...
public JSHOP2Parser(ParserSharedInputState state) {
  ...
  tokenNames = _tokenNames;
	...
	public final void prob() throws RecognitionException, TokenStreamException, IOException {
		...
		System.out.println(domain.getClass().getSimpleName().toLowerCase());
		def.problemMod.initProblem(states.getFirst(), taskLists.getFirst(),domain.getName().toLowerCase());//Mod Mayukh Das
