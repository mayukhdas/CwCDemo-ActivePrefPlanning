...
public class InternalDomain
{
  ...
  */
	//---changes by Mayukh Das
	public static Vector<String> constantsGlobal;
	public static int constantsSizeGlobal;
	//-----------------------
  ...
  */
              ...
              throws IOException
  {
    ...
    constantsGlobal = (Vector<String>)constants.clone();
    constantsSizeGlobal = constantsSize;
    //--------------------
