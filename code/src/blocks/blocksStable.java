...
class Precondition7 extends Precondition
{
	...
	public Precondition7(Term[] unifier)
	{
		...
		p[2] = new PreconditionAtomic(new Predicate(0, 4, new TermList(TermVariable.getVariable(3), TermList.NIL)), unifier);
		b = new Term[3][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
class Method9 extends Method
{
	public Method9()
	{
		super(new Predicate(9, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))));
		TaskList[] subsIn = new TaskList[1];
	...
	TaskList createTaskList0()
	{
		...
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(3, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(2), TermList.NIL))), false, true));
		retVal.subtasks[1] = new TaskList(new TaskAtom(new Predicate(2, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), false, true));
		retVal.subtasks[2] = new TaskList(new TaskAtom(new Predicate(4, 4, new TermList(new TermList(TermConstant.getConstant(6), new TermList(TermVariable.getVariable(0), TermList.NIL)), TermList.NIL)), false, true));
		retVal.subtasks[3] = new TaskList(new TaskAtom(new Predicate(5, 4, new TermList(new TermList(TermConstant.getConstant(9), new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), TermList.NIL)), false, true));
		retVal.subtasks[4] = new TaskList(new TaskAtom(new Predicate(6, 4, new TermList(TermVariable.getVariable(0), TermList.NIL)), false, false));
		retVal.subtasks[5] = new TaskList(new TaskAtom(new Predicate(7, 4, new TermList(TermVariable.getVariable(2), TermList.NIL)), false, false));
		retVal.subtasks[6] = new TaskList(new TaskAtom(new Predicate(8, 4, new TermList(TermVariable.getVariable(2), TermList.NIL)), false, false));
...
class Method10 extends Method
{
	...
	TaskList createTaskList0()
	{
		...
		retVal.subtasks[0] = new TaskList(new TaskAtom(new Predicate(3, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(2), TermList.NIL))), false, true));
		retVal.subtasks[1] = new TaskList(new TaskAtom(new Predicate(2, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(3), TermList.NIL))), false, true));
		retVal.subtasks[2] = new TaskList(new TaskAtom(new Predicate(3, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(3), TermList.NIL))), false, true));
		retVal.subtasks[3] = new TaskList(new TaskAtom(new Predicate(2, 4, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), false, true));
		retVal.subtasks[4] = new TaskList(new TaskAtom(new Predicate(4, 4, new TermList(new TermList(TermConstant.getConstant(6), new TermList(TermVariable.getVariable(0), TermList.NIL)), TermList.NIL)), false, true));
		retVal.subtasks[5] = new TaskList(new TaskAtom(new Predicate(5, 4, new TermList(new TermList(TermConstant.getConstant(9), new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))), TermList.NIL)), false, true));
		retVal.subtasks[6] = new TaskList(new TaskAtom(new Predicate(6, 4, new TermList(TermVariable.getVariable(0), TermList.NIL)), false, false));
		retVal.subtasks[7] = new TaskList(new TaskAtom(new Predicate(7, 4, new TermList(TermVariable.getVariable(2), TermList.NIL)), false, false));
		retVal.subtasks[8] = new TaskList(new TaskAtom(new Predicate(8, 4, new TermList(TermVariable.getVariable(2), TermList.NIL)), false, false));
...
class Precondition9 extends Precondition
{
	...
	public Precondition9(Term[] unifier)
	{
		...
		p[2] = new PreconditionAtomic(new Predicate(0, 2, new TermList(TermVariable.getVariable(0), TermList.NIL)), unifier);
		p[3] = new PreconditionAtomic(new Predicate(0, 2, new TermList(TermVariable.getVariable(1), TermList.NIL)), unifier);
		b = new Term[4][];
		b[0] = unifier;
		b[0] = Term.merge( b, 1 );
...
class Method11 extends Method
{
	public Method11()
	{
		super(new Predicate(9, 2, new TermList(TermVariable.getVariable(0), new TermList(TermVariable.getVariable(1), TermList.NIL))));
		TaskList[] subsIn = new TaskList[1];
	...
	public String getLabel(int which)
	{
		switch (which)
		{
			case 0: return "method-for-moving-x-from-table-to-z";
			default: return null;
		}
	}
}
...
public class blocksStable extends Domain
{
	public blocksStable()
	{
		...
		methods[9] = new Method[3];
		methods[9][0] = new Method9();
		methods[9][1] = new Method10();
		methods[9][2] = new Method11();
