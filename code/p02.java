...
public class p02
{
	...
	{
		String[] problemConstants = new String[21];
		...
		problemConstants[9] = "waypoint0";
		problemConstants[10] = "waypoint";
		problemConstants[11] = "waypoint1";
		problemConstants[12] = "waypoint2";
		problemConstants[13] = "waypoint3";
		problemConstants[14] = "camera0";
		problemConstants[15] = "camera";
		problemConstants[16] = "camera1";
		problemConstants[17] = "objective0";
		problemConstants[18] = "objective";
		problemConstants[19] = "objective1";
		problemConstants[20] = "channel_free";
	...
	private static void createState0(State s)	{
		...
		s.add(new Predicate(20, 0, new TermList(TermConstant.getConstant(42), new TermList(TermConstant.getConstant(53), TermList.NIL))));
		s.add(new Predicate(2, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(51), TermList.NIL))));
		...
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(53), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(53), new TermList(TermConstant.getConstant(51), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(51), new TermList(TermConstant.getConstant(54), TermList.NIL)))));
		s.add(new Predicate(0, 0, new TermList(TermConstant.getConstant(48), new TermList(TermConstant.getConstant(54), new TermList(TermConstant.getConstant(51), TermList.NIL)))));
		...
		s.add(new Predicate(14, 0, new TermList(TermConstant.getConstant(56), new TermList(TermConstant.getConstant(59), TermList.NIL))));
		...
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(56), new TermList(TermConstant.getConstant(47), TermList.NIL))));
		s.add(new Predicate(16, 0, new TermList(TermConstant.getConstant(58), new TermList(TermConstant.getConstant(48), TermList.NIL))));
		s.add(new Predicate(14, 0, new TermList(TermConstant.getConstant(58), new TermList(TermConstant.getConstant(61), TermList.NIL))));
		s.add(new Predicate(18, 0, new TermList(TermConstant.getConstant(58), new TermList(TermConstant.getConstant(46), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(59), new TermList(TermConstant.getConstant(51), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(61), new TermList(TermConstant.getConstant(51), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(61), new TermList(TermConstant.getConstant(53), TermList.NIL))));
		s.add(new Predicate(15, 0, new TermList(TermConstant.getConstant(61), new TermList(TermConstant.getConstant(54), TermList.NIL))));
	}

	public static LinkedList<Plan> getPlans()
	{
		LinkedList<Plan> returnedPlans = new LinkedList<Plan>();
		TermConstant.initialize(63);
